          ...
          <div className={`carousel-item ${activeIndex === 0 ? "active" : ""}`}>
            <div className="row mt-5">
              <div className="col-11">
                ...
                <div className="mt-4 heroHead pt-3">Your Gateway to Pre-IPO Companies</div>
                <p
                ...
                <div className="heroSub">Are you ready to join SpaceX on its IPO journey?</div>
                ...
                <div className="col-lg-3 col-sm-6 mt-5 p-0 mr-3">
                  <CreateAccountModal
                    text={"Join for free now"}
                   
                  />
                </div>
                <div className="col-lg-3 col-sm-6 mt-5 p-0">
                  <OutlinedButtonLight
          ...
          <div className={`carousel-item ${activeIndex === 1 ? "active" : ""}`}>
            <div className="row mt-5">
              <div className="col-7">
                ...
                <h4 className="mt-4 pt-3">Your Exclusive Gateway to Pre-IPO Companies</h4>
                <p
                  className="text-basic text-light-c w-70 mb-0"
                  style={{ lineHeight: "1.7em" }}
                >
                 Are you interested in the leading companies that are shaping our future?
                </p>
                <p className="text-basic text-light-c w-65">
                 Would You like to learn more about these companies? <br />Do you want to get rewarded for your interest in these Pre-IPo companies?
                </p>
                ...
                <p
                  ...
                  style={{ lineHeight: "1.7em" }}
                >
                 iVest Club is open to everyone worldwide apart from US residents and Nationals
                </p>

                <div className="w-100 d-flex  flex-column mt-5 ">
                <div className="col-lg-11 col-sm-6 mb-4 p-0">
                <CreateAccountModal
                    text={"Yes, Im ready to start my Pre-IPo journey by joining iVest Club for Free!"}
                   
                  />
                
                </div>
                <div className="col-lg-8 col-sm-6 p-0">
                <FilledButtonLight onClick={() => handlePresentationClick(2)} text={"Not Yet I want to learn more about iVest Club first!"} />
                </div>
              </div>
            ...
            <div className="row mt-5">
              <div className="col-7">
                ...
                <p
                  ...
                  style={{ lineHeight: "1.7em" }}
                >
                Are you aware that there are a growing number of companies that are privately owned and that knowledgeable wealthy people have access to them and are a step ahead of you?
                </p>
                
                <p className="text-basic text-light-c w-61" style={{marginTop:"20px"}}>
                 Would you like to get exclusive access to these companies just like them?
                </p>

                <div className="w-100 d-flex">
                <div className="col-lg-4 col-sm-6 mt-5 p-0">
            
                  <FilledButtonLight onClick={() => handlePresentationClick(3)} text={"Tell me more!"} />
                </div>
            ...
            <div className="row mt-5">
              <div className="col-7">
                ...
                <p
                  ...
                  style={{ lineHeight: "1.7em" }}
                >
               Did you know some of the best returns are from knowing comanies before they IPO?
                </p>

                <p style={{marginTop:"20px"}} className="text-basic text-light-c w-60">
                Do you own these stocks and wish you had known about them before they did their IPO - Join us at iVest Club to lget access to these companies?
                </p>

                <div className="w-100 d-flex">
                <div className="col-lg-4 col-sm-6 mt-5 p-0">
                  <FilledButtonLight onClick={() => handlePresentationClick(4)} text={"Tell me more!"} />
                </div>
            ...
            <div className="row mt-5">
              <div className="col-7">
                ...
                <p
                  ...
                  style={{ lineHeight: "1.7em" }}
                >
              Ae you ready to get access to Pre-IPO companies like SpaceX, OpenAI and many more?
                </p>
                <p className="text-basic text-light-c w-50">
                Join other like-minded peers to get your exclusive access to companies just like high net worth individuals and start earning rewards!
                </p>
              ...
              <div className="col-lg-9 col-sm-6 mt-5 p-0">
                  ...
                  <CreateAccountModal
                    text={" I’m in, this is my email - start my free registration!"}
              ...
              <div className="w-100 d-flex">
                <div className="col-lg-5 col-sm-6 mt-5 p-0">
                  <FilledButtonLight onClick={() => handlePresentationClick(3)} text={"Enter: Email Address here"} />
                </div>
